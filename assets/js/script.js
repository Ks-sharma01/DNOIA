...
if (membershipForm) {
    ...
    function validateActiveSubscriber() {
        ...
        if (!/^[0-9]+$/.test(value)) {
            ...
            active_subscribers_err.textContent = "Enter digits only.";
    ...
    function validateIssueDate() {
        ...
        if (value > today) {
            ...
            license_issue_date_err.textContent = "Issue date cannot be in the future.";
    ...
    function validateStep8() {
        return (
            ...
            validateSignatoryDesignation() &&
            validateSignatureFile() &&
            validateSignatoryDate() &&
    ...
    document.getElementById("membershipForm")
        .addEventListener("submit", function (e) {
            ...
            if (!(validateStep1() && validateStep2() && validateStep3() && validateStep4() &&
                validateStep4() && validateStep5() && validateStep6())) {
